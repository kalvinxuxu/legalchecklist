...
// Global UI components with Ui prefix
app.component('UiButton', UiButton)
app.component('UiCard', UiCard)
app.component('UiCardHeader', UiCardHeader)
app.component('UiCardTitle', UiCardTitle)
app.component('UiCardContent', UiCardContent)
app.component('UiBadge', UiBadge)
app.component('UiInput', UiInput)
app.component('UiLabel', UiLabel)
app.component('UiSeparator', UiSeparator)
app.component('UiProgress', UiProgress)
app.component('UiCheckbox', UiCheckbox)
app.component('UiTabs', UiTabs)
app.component('UiTabsList', UiTabsList)
